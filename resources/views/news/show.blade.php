                ...
                <div class="col-lg-12">
                    <div class="breadcrumb_iner text-center">
                        <div class="breadcrumb_iner_item">
                            <h2>News Detail</h2>
                            <p>Home<span>-</span>All News<span>-</span>News</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-8 posts-list">
                <div class="single-post">
                        <div class="feature-img">
                            <img class="img-fluid" src="{{$new->image}}" style='object-fit:cover; width:100%' alt="">
                        </div>
                  ...
                  <div class="navigation-area">
                     <div class="row">
                        ...
                        <div class="col-lg-6 col-md-6 col-12 nav-left flex-row d-flex justify-content-start align-items-center">
                            @if($preNew)
                            <div class="thumb">
                                <a href="{{route('news.show', $preNew)}}">
                                    <img class="img-fluid" style='object-fit:cover; width:150px; height:90px' src="{{ $preNew->image}}" alt="">
                                </a>
                            </div>
                            <div class="arrow">
                                <a href="{{route('news.show', $preNew)}}">
                        ...
                        <div class="col-lg-6 col-md-6 col-12 nav-right flex-row d-flex justify-content-end align-items-center">
                            ...
                            <div class="detials">
                                <p>Next Post</p>
                                <a href="{{route('news.show', $nextNew)}}">
                                    <h4>{{$nextNew->title}}</h4>
                                </a>
                            </div>
                            <div class="arrow">
                            ...
                            <div class="thumb">
                                <a href="{{route('news.show', $nextNew)}}">
                                    <img class="img-fluid" style='object-fit:cover; width:150px; height:90px' src="{{$nextNew->image}}" alt="">
                                </a>
                            </div>
                            @endif
                        </div>
               ...
               <div class="blog-author">
                  <div class="media align-items-center">
                     <img src="{{$new->user->profile->profile_image}}" alt="">
                ...
                <div class="blog_right_sidebar">
                    ...
                    <aside class="single_sidebar_widget popular_post_widget">
                            ...
                            <div class="media post_item">
                                <img src="{{$recent->image}}" style='width:100px; object-fit:cover, height:100px;' alt="post">
                                <div class="media-body">
                                    <a href="{{route('news.show', $recent)}}">
                                        <h3>{{$recent->title}}</h3>
                                    </a>
                                <p>{{$recent->updated_at}}</p>
                                </div>
                            </div>
                            @endforeach
                    </aside>
